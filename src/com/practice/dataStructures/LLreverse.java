...
public class LLreverse {
	...
	public void push(int value) {
		if (head == null) {
			head = new Node(value);
			System.out.println("added the head node" + head.data);
			return;
		}
		Node temp = head;
	...
	public void addLL(int value) {
		if (head == null) {
			head = new Node(value);
			System.out.println("added head node value is " + head.data);
			return;
		}
		Node node = head;
		...
		System.out.println("added node value is " + node.next.data);
	}
